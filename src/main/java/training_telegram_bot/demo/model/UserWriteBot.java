...
public class UserWriteBot {
  ...
  @Id
  @SequenceGenerator(name = "generator", sequenceName = "user_writeBot_generator")
  @GeneratedValue(generator = "user_writeBot_generator", strategy = GenerationType.SEQUENCE)
  @Column(name = "ID")
  private Long id;
